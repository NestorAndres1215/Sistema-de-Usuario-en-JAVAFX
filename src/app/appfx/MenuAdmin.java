...
public class MenuAdmin extends Application {
   ...
   private void mostrarListadoUsuarios() {
    ...
    tableView.getColumns().addAll(codigoCol, userCol, nombreCol, apellidoCol);
    ...
    btnActualizar.setOnAction(e -> {
        ...
        if (selectedUser != null) {
            ...
            System.out.println("Actualizar usuario: " + selectedUser.getUsername());
        } else {
            showAlert("Selecciona un usuario para actualizar.");
        }
    });

    btnLeer.setOnAction(e -> {
        // Lógica para leer el usuario seleccionado
        Usuario selectedUser = tableView.getSelectionModel().getSelectedItem();
        if (selectedUser != null) {
            System.out.println("Leer usuario: " + selectedUser.getUsername());
        } else {
            showAlert("Selecciona un usuario para leer.");
        }
    });
